...
<div id="content" class="main-content">
    <div class="layout-px-spacing">
        <div class="breadcrum-wrap layout-top-spacing col-12 xs-p-0">
            <div class="row">
                <div class="col-lg-6">
                    <h4 class="text-uppercase sb-heading">EMAIL TEMPLATE</h4>
                </div>
                <div class="col-lg-6 text-right">
                    <nav class="breadcrumb-one" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><span>Email template</span></li>
                        </ol>
                    </nav>
                </div>
            </div>
                    ...
                    <table class="table table-bordered table-striped mb-4">
                        ...
                        <tbody>
                            <tr>
                                <td>1</td>
                                <td>Customer</td>
                                <td>confirmation Mail from _system_name_ for reset</td>
                                  <td> <i class="fa fa-angle-left" aria-hidden="true"></i> &nbsp;&nbsp;table align="center" border="0" cellpaddi&nbsp;&nbsp;<i class="fa fa-angle-right" aria-hidden="true"></i></td>
                                <td>Welcome to _system_ name_ !</td>

...
<div id="content" class="main-content">
    <div class="layout-px-spacing">
        <div class="breadcrum-wrap layout-top-spacing col-12 xs-p-0">
            <div class="row">
                <div class="col-lg-6">
                    <h4 class="text-uppercase sb-heading">PROVIDER STATEMENT</h4>
                </div>
                <div class="col-lg-6 text-right">
                    <nav class="breadcrumb-one" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="#">Dispatcher panel</a></li>
                            <li class="breadcrumb-item active" aria-current="page"><span>Provider statement</span></li>
                        </ol>
                    </nav>
                </div>
            </div>
                    ...
                    <table class="table table-bordered table-striped mb-4">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>1</td>
                                <td><svg xmlns="http://www.w3.org/2000/svg" width="7.384" height="11.635" viewBox="0 0 7.384 11.635"><g transform="translate(-778 -708)"><path d="M785.384,708H778v1.467h2.6a2.2,2.2,0,0,1,2.075,1.467H778V712.4h4.679a2.2,2.2,0,0,1-2.075,1.467H778v1.467l4.3,4.3,1.037-1.037-3.262-3.262h.529A3.674,3.674,0,0,0,784.2,712.4h1.186v-1.467H784.2a3.65,3.65,0,0,0-.661-1.467h1.848Zm0,0"/></g></svg> 20000</td>
                                <td>10</td>
                                <td>1-9-2020</td>
                            </tr>
                             <tr>

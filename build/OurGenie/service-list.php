...
<div id="content" class="main-content">
    <div class="layout-px-spacing">
        <div class="breadcrum-wrap layout-top-spacing col-12 xs-p-0">
            <div class="row">
                <div class="col-lg-6">
                    <h4 class="text-uppercase sb-heading">SERVICES LIST</h4>
                </div>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped mb-4">
                        ...
                        <tbody>
                            <tr>
                                <td>1</td>
                                <td>Fan instalation and fiting</td>
                                <td>10 </td>
                                <td class="text-center">
                                    <ul class="table-controls d-flex align-items-center justify-content-center">
                                        <li><a href="javascript:void(0);" data-toggle="tooltip" data-placement="top" title="Settings"><svg xmlns="http://www.w3.org/2000/svg" width="16.2" height="10.325" viewBox="0 0 16.2 10.325">
                                                    <defs>
                                                        <style>
                                                            .view {
                                                                fill: #0d004c;

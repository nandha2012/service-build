        ...
        <div class="breadcrum-wrap layout-top-spacing col-12 xs-p-0">
            <div class="row">
                <div class="col-lg-6col-md-6 ">
                    <h4 class="text-uppercase sb-heading">SERVICE PROVIDER</h4>
                </div>
                <div class="col-lg-6 col-md-6 text-right">
                    <nav class="breadcrumb-one" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><span>Services Provider</span></li>
                        </ol>
                    </nav>
                </div>
            </div>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped mb-4">
                        ...
                        <tbody>
                            <tr>
                                <td>1</td>
                                <td>Electical work ...</td>
                                <td>Jone doe</td>
                                <td>10 </td>
                                <td>10 </td>
                                <td><img src="assets/img/document-icon.svg" class="img-fluid"></td>
                            ...
                            <tr>
                                ...
                                <td>10 </td>
                               <td><img src="assets/img/document-icon.svg" class="img-fluid"></td>
                                <td class="text-center">  <span class="badge outline-badge-danger shadow-none">Inactive</span></td>

        ...
        <div class="breadcrum-wrap layout-top-spacing col-12 xs-p-0">
            <div class="row">
                <div class="col-lg-6 col-md-6">
                    <h4 class="text-uppercase sb-heading">WAITING FOR APPROVAL</h4>
                </div>
                <div class="col-lg-6 col-md-6 text-right">
                    <nav class="breadcrumb-one" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><span>Waiting for approval</span></li>
                        </ol>
                    </nav>
                </div>
            </div>
                    ...
                    <table class="table table-bordered table-striped mb-4">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>John Doe</td>
                                <td>Electrical</td>
                                <td class="text-center"><img src="assets/img/document-icon.svg" class="img-fluid"></td>
                            ...
                            <tr>
                                ...
                                <td>Electrical</td>
                                <td class="text-center"><img src="assets/img/document-icon.svg" class="img-fluid"></td>
                             <td class="text-center">  <span class="badge outline-badge-danger shadow-none">Decline</span></td>
